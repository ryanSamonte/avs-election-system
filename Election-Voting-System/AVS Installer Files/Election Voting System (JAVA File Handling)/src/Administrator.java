...
public class Administrator extends JFrame implements MenuListener,ActionListener,KeyListener{
	...
	ImageIcon icon = new ImageIcon((Administrator.class.getResource("/icon.PNG")));
	...
	public Administrator(){
		...
		admin.setContentPane(new JLabel(new ImageIcon(Administrator.class.getResource("/Admin.jpg"))));
		//Menu Bar
		adMenu.add(result);
		...
		addCanButton.setIcon(new ImageIcon(Administrator.class.getResource("/addCan.png")));
		...
		editCanButton.setIcon(new ImageIcon(Administrator.class.getResource("/editCan.png")));
		...
		delCanButton.setIcon(new ImageIcon(Administrator.class.getResource("/delCan.png")));
		...
		seaCanButton.setIcon(new ImageIcon(Administrator.class.getResource("/seaCan.png")));
		admin.add(seaCanButton);
	    seaCanButton.addActionListener(this);
		//Voter
		addVotButton = new JButton("Add Voter");
		addVotButton.setIcon(new ImageIcon(Administrator.class.getResource("/addVot.png")));
		...
		editVotButton.setIcon(new ImageIcon(Administrator.class.getResource("/editVot.png")));
		...
		delVotButton.setIcon(new ImageIcon(Administrator.class.getResource("/delVot.PNG")));
		admin.add(delVotButton);
		delVotButton.addActionListener(this);
		
		seaVotButton = new JButton("Search Voter");
		seaVotButton.setIcon(new ImageIcon(Administrator.class.getResource("/seaVot.png")));
	...
	newButton.setIcon(new ImageIcon(Administrator.class.getResource("/clearBut.PNG")));
	addButton = new JButton("ADD");
	addButton.setBounds(400, 357,115,40);
	addButton.setIcon(new ImageIcon(Administrator.class.getResource("/addBut.PNG")));
	cancelButton = new JButton("BACK");
	cancelButton.setBounds(520, 357,115,40);
	cancelButton.setIcon(new ImageIcon(Administrator.class.getResource("/backBut.PNG")));
	...
	addButton.addActionListener(new ActionListener(){
		public void actionPerformed(ActionEvent b) {
            try
			{
            	    File allInfo = new File("Candidate.txt");
  					File candidateNames = new File(position.getSelectedItem()+".txt");
   ...
   if(allInfo.exists() && candidateNames.exists())
	...
	searchButton.setIcon(new ImageIcon(Administrator.class.getResource("/addBut.PNG")));
	cancelButton1 = new JButton("BACK");
	cancelButton1.setBounds(470, 357,120,40);
	cancelButton1.setIcon(new ImageIcon(Administrator.class.getResource("/backBut.PNG")));
	updateButton1 = new JButton("UPDATE");
	updateButton1.setBounds(210, 357,120,40);
	updateButton1.setIcon(new ImageIcon(Administrator.class.getResource("/backBut.PNG")));
	...
	public void deletingCandidate(){
	    ...
	    delCan.setContentPane(new JLabel(new ImageIcon(Administrator.class.getResource("/delCan.jpg"))));
		
		searchButton2 = new JButton("SEARCH");
		searchButton2.setBounds(330, 280,120,40);
		searchButton2.setIcon(new ImageIcon(Administrator.class.getResource("/seaBut.PNG")));
		delCan.add(searchButton2);
		cancelButton2 = new JButton("BACK");
		cancelButton2.setBounds(480, 280,120,40);
		cancelButton2.setIcon(new ImageIcon(Administrator.class.getResource("/backBut.PNG")));
	...
	public void searchingCandidate(){
		...
		seaCan.setContentPane(new JLabel(new ImageIcon(Administrator.class.getResource("/seaCan.jpg"))));
		
		searchButton3 = new JButton("SEARCH");
		searchButton3.setBounds(330, 280,120,40);
		searchButton3.setIcon(new ImageIcon(Administrator.class.getResource("/seaBut.PNG")));
		seaCan.add(searchButton3);
		cancelButton3 = new JButton("BACK");
		cancelButton3.setBounds(480, 280,120,40);
		cancelButton3.setIcon(new ImageIcon(Administrator.class.getResource("/backBut.PNG")));
	   ...
	   if(allInfo.exists() && allInfo1.exists())
		...
		public void deletingVoter(){
			final JFrame delVot = new JFrame();
		          ...
		          delVot.setContentPane(new JLabel(new ImageIcon(Administrator.class.getResource("/delVot.jpg"))));
		...
		public void searchingVoter(){
		    ...
		    seaVot.setContentPane(new JLabel(new ImageIcon(Administrator.class.getResource("/seaVot.jpg"))));
...
public void result(){
	    	...
	    	search.setIcon(new ImageIcon(Administrator.class.getResource("/seaBut.PNG")));
	    	...
	    	resF.setContentPane(new JLabel(new ImageIcon(Administrator.class.getResource("/resultSearch.jpg"))));
...
public void resFrame(){
		   ...
		   result.setContentPane(new JLabel(new  ImageIcon(Administrator.class.getResource("/resFrame.jpg"))));
...
public void allCan(){ 
    JFrame allCan = new JFrame("Candidate's List");
       ...
       allCan.setContentPane(new JLabel(new  ImageIcon(Administrator.class.getResource("/allCan.jpg"))));
	   JPanel pan = new JPanel();
	   pan.setLayout(null);
...
public void allVot(){ 
    JFrame allVot = new JFrame("Voter's List");
       ...
       allVot.setContentPane(new JLabel(new  ImageIcon(Administrator.class.getResource("/allVot.jpg"))));
	   JPanel pan = new JPanel();
	   pan.setLayout(null);
	   pan.setBounds(10, 75, 754, 250);
	   pan.setBackground(Color.WHITE);
