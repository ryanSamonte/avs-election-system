...
public class voterLogInForm extends JFrame implements ActionListener{
	...
	public voterLogInForm(){
		...
		voterLog.setContentPane(new JLabel(new ImageIcon("VoterForm.JPG")));
		...
		vlogIn.setIcon(new ImageIcon("LogIn.png"));		
		voterLog.add(vlogIn);
		...
		vcancel.setIcon(new ImageIcon("Cancel.png"));
	...
	public void voting(){
		...
		voter.setContentPane(new JLabel(new ImageIcon("VoterF.jpg")));
		...
		presBut.setIcon(new ImageIcon("presBut.png"));
		voter.add(presBut);
		...
		vicePresBut.setIcon(new ImageIcon("vicePresBut.png"));
		...
		secBut.setIcon(new ImageIcon("secBut.png"));
		voter.add(secBut);
		...
		treasBut.setIcon(new ImageIcon("treasBut.png"));
		voter.add(treasBut);
		...
		audiBut.setIcon(new ImageIcon("audiBut.png"));
		voter.add(audiBut);
		...
		pioBut.setIcon(new ImageIcon("pioBut.png"));
		voter.add(pioBut);
		...
		voter.add(castBut);
		castBut.setIcon(new ImageIcon("cVote.png"));
	...
	public void president(){
		...
		presVote.setContentPane(new JLabel(new ImageIcon("presVote.jpg")));
		...
		Cvote.setIcon(new ImageIcon("vote.png"));
		abstain.setIcon(new ImageIcon("abstainBut.png"));
	...
	public void vPres(){
		...
		vPresVote.setContentPane(new JLabel(new ImageIcon("vpresVote.jpg")));
	...
	public void secretary(){
		...
		secVote.setContentPane(new JLabel(new ImageIcon("secVote.jpg")));
	...
	public void treasurer(){
		...
		treasVote.setContentPane(new JLabel(new ImageIcon("treasVote.jpg")));
	...
	public void PIO(){
		...
		pioVote.setContentPane(new JLabel(new ImageIcon("pioVote.jpg")));
	...
	public void cast(){
		...
		castV.setContentPane(new JLabel(new ImageIcon("vConf.jpg")));
		...
		conf.setIcon(new ImageIcon("conf.png"));
